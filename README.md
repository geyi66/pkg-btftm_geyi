...
This repository contains the Debian packaging for btftm prebuilt binaries within the Qualcomm Linux ecosystem. It provides the essential structure and configuration necessary to integrate with the [qcom-build-utils](https://github.com/qualcomm-linux/qcom-build-utils) repository, enabling standardized Debian package building processes.
...
pkg-btftm is licensed under the [BSD-3-Clause License](https://spdx.org/licenses/BSD-3-Clause.html). See [LICENSE.txt](LICENSE.txt) for the full license text.
